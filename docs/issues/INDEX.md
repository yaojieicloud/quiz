...
| BUG-8 | 提交报错一闪而过 + 422 detail 数组被当字符串（错误弹窗手动关 + 复制 + 全链路日志） | 体验问题/审计 | — | — | 🟢已关闭（2026-09-04 本地验证+ECS部署成功，commit `8349f4b`，详见 BUG-8.md） |
| BUG-9 | 阅读理解 4 子题切选计时永远不达 10s + admin 调试无时间限制 | 体验问题 | — | — | 🟢已关闭（2026-09-04 详见 BUG-9.md） |
