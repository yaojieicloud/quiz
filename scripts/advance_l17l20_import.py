"""L17-L20 (topic 61-64) 进阶题：导入 ECS + 组卷/评分验证 + 清理验证记录。"""
import urllib.request, json, sys, os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from advance_l17l20_verify import QUESTIONS
...
# ---- 评分验证：提交参考解（admin 作答），确认 llm_score>=60 且积分>0 ----
